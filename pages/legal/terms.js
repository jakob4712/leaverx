...
export default function Terms() {
  return (
    <>
      <Nav />
      <LegalLayout title="Terms of Service" updated="2026-04-15">
        <p>By using LeaveRx, you agree to these Terms. LeaveRx provides a telehealth platform that connects patients with independently licensed physicians for the purpose of medical leave certification.</p>
